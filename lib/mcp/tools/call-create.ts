...
export function registerCallCreate(server: McpServer) {
  ...
  {
    properties: z.record(z.string()).describe("通話のプロパティ（キー:値）。hs_timestampは必須。主要プロパティ: hs_call_title, hs_call_body, hs_call_duration(ミリ秒), hs_call_direction(INBOUND/OUTBOUND), hs_call_status(COMPLETED/BUSY/NO_ANSWER等), hs_call_from_number, hs_call_to_number, hs_call_recording_url(HTTPS .mp3/.wav), hubspot_owner_id。hs_call_disposition(結果GUID): Busy=9d9162e7-6cf3-4944-bf63-4dff82258764, Connected=f240bbac-87c9-4f6e-bf70-924b57d47db7, Left live message=a4c4c377-d246-4b32-a13b-75a56a4cd0ff, Left voicemail=b2cf5968-551e-4856-9783-52b3da59a7d0, No answer=73a0d17f-1163-4015-bdd5-ec830791da20, Wrong number=17b47fee-58de-441e-a44c-c6300d46f273"),
