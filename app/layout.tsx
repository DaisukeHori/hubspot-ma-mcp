...
export const metadata: Metadata = {
  title: "HubSpot MA MCP Server — 128ツール搭載のマーケティング自動化AI基盤",
  description:
  ...
  openGraph: {
    ...
    description:
      "AIをHubSpotのMA担当者にする。128ツール + Knowledge Store + Claude Skill",
  ...
  twitter: {
    ...
    title: "HubSpot MA MCP Server — 116 Tools",
    description:
      "Claude AIからHubSpotのMA全操作を可能にする128ツール搭載MCPサーバー",
    images: ["/og-image.png"],
  },
  icons: {
    icon: [
