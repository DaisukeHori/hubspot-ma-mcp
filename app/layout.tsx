...
export const metadata: Metadata = {
  title: "HubSpot MA MCP Server — 126ツール搭載のマーケティング自動化AI基盤",
  description:
  ...
  openGraph: {
    ...
    description:
      "AIをHubSpotのMA担当者にする。126ツール + Knowledge Store + Claude Skill",
  ...
  twitter: {
    ...
    title: "HubSpot MA MCP Server — 116 Tools",
    description:
      "Claude AIからHubSpotのMA全操作を可能にする126ツール搭載MCPサーバー",
    images: ["/og-image.png"],
  },
  icons: {
    icon: [
